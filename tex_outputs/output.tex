...
\usepackage{etoolbox}
\usepackage[
    pdftitle={TESTING NAMES},
    pdfauthor={TESTING NAMES},
...
\begin{header}
    \textbf{\fontsize{24 pt}{24 pt}\selectfont TESTING NAMES}

    \vspace{0.3 cm}

    \normalsize
    \mbox{{\color{black}\footnotesize\faMapMarker*}\hspace*{0.13cm}Ottawa, ON}%
    \AND
...
\section{Education}
\begin{twocolentry}{%
\textit{2024 }\textit{Present} \\[0.1cm]
\textit{Ottawa, ON}%
}
